...
export default function Create() {
    ...
    return (
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-black text-gray-900 leading-tight">
                                {isBn ? 'নতুন গ্রাহক যুক্ত করুন' : 'Add Customer'}
                            </h2>
                            <p className="text-xs text-gray-500">
                                {isBn ? 'গ্রাহকের ব্যক্তিগত ও অ্যাকাউন্টের তথ্য পূরণ করুন' : 'Fill in the customer details and account limits'}
                            </p>
                        </div>
                    </div>
                    <Link 
        ...
        >
            <Head title={isBn ? 'নতুন গ্রাহক' : 'Add Customer'} />
