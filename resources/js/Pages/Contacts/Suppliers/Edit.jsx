...
export default function Edit({ supplier }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        nid_number: supplier.nid_number || '',
    ...
    return (
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-black text-gray-900 leading-tight">
                                {isBn ? 'সরবরাহকারী সম্পাদনা' : 'Edit Supplier'} - {supplier.company_name || supplier.name}
                            </h2>
                            <p className="text-xs text-gray-500">
                                {isBn ? 'সরবরাহকারী প্রতিষ্ঠানের তথ্য আপডেট করুন' : 'Update the supplier business profile'}
                            </p>
                        </div>
                    </div>
                    <Link 
        ...
        >
            <Head title={`${isBn ? 'সরবরাহকারী সম্পাদনা' : 'Edit Supplier'} - ${supplier.company_name || supplier.name}`} />
                    ...
                    <div className="bg-white shadow-sm rounded-2xl border border-gray-100 overflow-hidden">
                        ...
                        <div className="bg-gray-50 px-6 py-4 border-t border-gray-100 flex justify-end">
                            ...
                            >
                                ...
                                {processing ? (isBn ? 'আপডেট হচ্ছে…' : 'Updating...') : (isBn ? 'আপডেট করুন' : 'Update Supplier')}
                            </button>
                        </div>
                    </div>
                </form>
