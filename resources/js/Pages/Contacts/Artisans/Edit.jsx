...
export default function Edit({ artisan }) {
    ...
    return (
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-black text-gray-900 leading-tight">
                                {isBn ? 'কারিগর সম্পাদনা' : 'Edit Artisan'} - {artisan.name}
                            </h2>
                            <p className="text-xs text-gray-500">
                                {isBn ? 'কারিগর ও স্বর্ণকারের তথ্য পরিবর্তন করুন' : 'Update the artisan details'}
                            </p>
                        </div>
                    </div>
                    <Link 
        ...
        >
            <Head title={`${isBn ? 'কারিগর সম্পাদনা' : 'Edit Artisan'} - ${artisan.name}`} />
                    ...
                    <div className="bg-white shadow-sm rounded-2xl border border-gray-100 overflow-hidden">
                        ...
                        <div className="bg-gray-50 px-6 py-4 border-t border-gray-100 flex justify-end">
                            ...
                            >
                                ...
                                {processing ? (isBn ? 'আপডেট হচ্ছে…' : 'Updating...') : (isBn ? 'আপডেট করুন' : 'Update Artisan')}
                            </button>
                        </div>
                    </div>
                </form>
