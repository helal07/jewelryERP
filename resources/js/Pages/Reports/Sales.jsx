...
export default function Sales({ sales = [], summary = {}, branches = [], customers = [], filters = {} }) {
            ...
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-2xl font-bold text-gray-900 tracking-tight flex items-center gap-2">
                        <LineChart className="w-7 h-7" style={{ color: 'rgb(177, 118, 51)' }} />
                        {t('salesReport')}
                    </h2>
        ...
        >
            ...
            <div className="hidden print:block mb-6 border-b border-gray-300 pb-3">
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <h2 className="text-sm font-semibold text-gray-700">{t('salesReport')}</h2>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-white border border-gray-100 p-4 rounded-2xl shadow-sm">
                    <p className="text-xs font-bold text-gray-500 uppercase">{t('totalSales') || 'Total Sales'}</p>
                            ...
                            {sales.length > 0 ? (
                                sales.map((sale) => (
                                    <tr key={sale.id} className="hover:bg-gray-50/50 transition">
                                        ...
                                        <td className="px-3.5 py-2.5 font-semibold text-gray-900">{sale.customer?.name || (isBn ? 'সাধারণ ক্রেতা' : 'Walk-in')}</td>
