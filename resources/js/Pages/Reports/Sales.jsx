...
import { 
    LineChart, Printer, Filter, ShoppingBag, CreditCard, RotateCcw
} from 'lucide-react';
                            ...
                            {sales.length > 0 ? (
                                sales.map((sale) => (
                                    <tr key={sale.id} className="hover:bg-gray-50/50">
                                        ...
                                        <td className="p-3.5 font-semibold text-gray-900">{sale.customer?.name || 'Walk-in'}</td>
