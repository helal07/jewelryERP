...
export default function Edit({ auth, staff, branches = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('hrm.staff.update', staff.id));
    };
    ...
    return (
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-black text-gray-900 leading-tight">
                                {isBn ? 'কর্মী সম্পাদনা' : 'Edit Staff'} - {staff.name}
                            </h2>
                            <p className="text-xs text-gray-500">
                                {isBn ? 'কর্মকর্তা ও কর্মচারীর তথ্য ও বেতন সংক্রান্ত বিবরণ পরিবর্তন করুন' : 'Update employee profile & salary information'}
                            </p>
                        </div>
                    </div>
                    <Link
        ...
        >
            <Head title={`${isBn ? 'কর্মী সম্পাদনা' : 'Edit Staff'} - ${staff.name}`} />
                ...
                <form onSubmit={submit} className="bg-white shadow-sm rounded-2xl border border-gray-100 p-6 md:p-8 space-y-6">
                    ...
                    <div className="flex justify-end pt-4 border-t border-gray-100">
                        ...
                        >
                            ...
                            <span>{processing ? (isBn ? 'আপডেট হচ্ছে…' : 'Updating...') : (isBn ? 'আপডেট সংরক্ষণ করুন' : 'Update Staff')}</span>
                        </button>
                    </div>
                </form>
            </div>
