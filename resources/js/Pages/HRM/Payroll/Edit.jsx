...
export default function Edit({ auth, payroll, staffs = [], branches = [] }) {
    ...
    return (
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-black text-gray-900 leading-tight">
                                {isBn ? 'পে-রোল সম্পাদনা করুন' : 'Edit Payroll'}
                            </h2>
                            <p className="text-xs text-gray-500">
                                {isBn ? 'কর্মীর মাসিক বেতন, ভাতা ও কর্তন সংশোধন করুন' : 'Update staff salary breakdown, allowances, deductions and status'}
                            </p>
                        </div>
                    </div>
                    <Link
        ...
        >
            <Head title={isBn ? 'পে-রোল সম্পাদনা' : 'Edit Payroll'} />
                ...
                <form onSubmit={submit} className="bg-white shadow-sm rounded-2xl border border-gray-100 p-6 md:p-8 space-y-6">
                    ...
                    <div className="flex justify-end pt-4 border-t border-gray-100">
                        ...
                        >
                            ...
                            <span>{processing ? (isBn ? 'আপডেট হচ্ছে…' : 'Updating...') : (isBn ? 'পে-রোল হালনাগাদ করুন' : 'Update Payroll')}</span>
                        </button>
                    </div>
                </form>
            </div>
